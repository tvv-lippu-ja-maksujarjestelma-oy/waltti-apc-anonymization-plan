...
Here is an example message from an onboard counting system into the APC backend:
...
Anonymizing mobility data per person has been shown to be infeasible [@zang_anonymization_2011; @de_montjoye_unique_2013].
